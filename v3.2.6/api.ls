...
test 'Biaodian jiya' ->
  ...
  */
  html-equal d.innerHTML, '<h-char unicode=300c class=biaodian cjk bd-open><h-cs hidden=\"\"> </h-cs><h-inner>「</h-inner></h-char>字<h-char unicode=300e class=biaodian cjk bd-open><h-cs hidden=\"\"> </h-cs><h-inner>『</h-inner></h-char>字<h-char-group class=biaodian cjk><h-char unicode=300f class=biaodian cjk bd-close bd-end><h-inner>』</h-inner><h-cs hidden=\"\"> </h-cs></h-char><h-char unicode=ff1f class=biaodian cjk bd-end><h-inner>？</h-inner><h-cs hidden=\"\"> </h-cs></h-char><h-char unicode=300d class=biaodian cjk bd-close bd-end><h-inner>」</h-inner><h-cs hidden=\"\"> </h-cs></h-char></h-char-group>字<h-char unicode=300c class=biaodian cjk bd-open><h-cs hidden=\"\"> </h-cs><h-inner>「</h-inner></h-char>字<h-char unicode=300e class=biaodian cjk bd-open><h-cs hidden=\"\"> </h-cs><h-inner>『</h-inner></h-char>字<h-char-group class=biaodian cjk><h-char unicode=300f class=biaodian cjk bd-close bd-end><h-inner>』</h-inner><h-cs hidden=\"\"> </h-cs></h-char><h-char unicode=300d class=biaodian cjk bd-close bd-end><h-inner>」</h-inner><h-cs hidden=\"\"> </h-cs></h-char></h-char-group>字<h-char unicode=ff1f class=biaodian cjk bd-end><h-inner>？</h-inner><h-cs hidden=\"\"> </h-cs></h-char>'
  ...
  .forEach ->
    it.removeAttribute \unicode
  */
  html-equal d.innerHTML, '字<h-char-group class=biaodian cjk><h-char unicode=3001 class=biaodian cjk bd-end><h-inner>、</h-inner><h-cs hidden=\"\"> </h-cs></h-char><h-char unicode=300c class=biaodian cjk bd-open><h-cs hidden=\"\"> </h-cs><h-inner>「</h-inner></h-char></h-char-group>字<h-char unicode=300d class=biaodian cjk bd-close bd-end><h-inner>」</h-inner><h-cs hidden=\"\"> </h-cs></h-char>字<h-char-group class=biaodian cjk><h-char unicode=ff0c class=biaodian cjk bd-end><h-inner>，</h-inner><h-cs hidden=\"\"> </h-cs></h-char><h-char unicode=ff08 class=biaodian cjk bd-open><h-cs hidden=\"\"> </h-cs><h-inner>（</h-inner></h-char></h-char-group>字<h-char unicode=ff09 class=biaodian cjk bd-close bd-end><h-inner>）</h-inner><h-cs hidden=\"\"> </h-cs></h-char>字<h-char-group class=biaodian cjk><h-char unicode=2026 class=biaodian cjk bd-liga>……</h-char><h-char unicode=300c class=biaodian cjk bd-open><h-cs hidden=\"\"> </h-cs><h-inner>「</h-inner></h-char></h-char-group>字<h-char-group class=biaodian cjk><h-char unicode=300d class=biaodian cjk bd-close bd-end><h-inner>」</h-inner><h-cs hidden=\"\"> </h-cs></h-char><h-char unicode=3002 class=biaodian cjk bd-end><h-inner>。</h-inner><h-cs hidden=\"\"> </h-cs></h-char></h-char-group>'
  ...
  .forEach ->
    it.removeAttribute \unicode
  */
  html-equal d.innerHTML, '<h-char unicode=300a class=biaodian cjk bd-open><h-cs hidden=\"\"> </h-cs><h-inner>《</h-inner></h-char>書名<h-char-group class=biaodian cjk><h-char unicode=300b class=biaodian cjk bd-close bd-end><h-inner>》</h-inner><h-cs hidden=\"\"> </h-cs></h-char><h-char unicode=3008 class=biaodian cjk bd-open><h-cs hidden=\"\"> </h-cs><h-inner>〈</h-inner></h-char></h-char-group>篇名<h-char-group class=biaodian cjk><h-char unicode=3009 class=biaodian cjk bd-close bd-end><h-inner>〉</h-inner><h-cs hidden=\"\"> </h-cs></h-char><h-char unicode=ff08 class=biaodian cjk bd-open><h-cs hidden=\"\"> </h-cs><h-inner>（</h-inner></h-char></h-char-group>內容<h-char unicode=ff09 class=biaodian cjk bd-close bd-end><h-inner>）</h-inner><h-cs hidden=\"\"> </h-cs></h-char>'
...
test 'Hanging Biaodian' !->
  ...
  d.innerHTML = '標點……。'
  Han d .renderHanging!
  html-equal d.innerHTML, '標點<h-hangable>……<h-cs><h-inner hidden=\"\"> </h-inner><h-char class=biaodian bd-close bd-end cjk>。</h-char></h-cs></h-hangable>'
...
test 'Jiya and Hanging' !->
  ...
  if support
    ...
    html-equal d.innerHTML, '<a href=#><h-char unicode=300a class=biaodian cjk bd-open><h-cs hidden=\"\"> </h-cs><h-inner>《</h-inner></h-char>書名<h-hangable><h-char unicode=300b class=biaodian cjk bd-close bd-end><h-inner>》</h-inner><h-cs hidden=\"\"> </h-cs></h-char><h-cs><h-inner hidden=\"\"> </h-inner><h-char class=biaodian bd-close bd-end cjk>、</h-char></h-cs></h-hangable></a><h-char-group class=biaodian cjk portion><h-char unicode=300c class=biaodian cjk bd-open><h-cs hidden=\"\"> </h-cs><h-inner>「</h-inner></h-char></h-char-group><h-char-group class=biaodian cjk portion><h-char unicode=300c class=biaodian cjk bd-open><h-cs hidden=\"\"> </h-cs><h-inner>「</h-inner></h-char></h-char-group><em><h-char-group class=biaodian cjk portion><h-char unicode=300c class=biaodian cjk bd-open><h-cs hidden=\"\"> </h-cs><h-inner>「</h-inner></h-char></h-char-group><h-char class=hanzi cjk>強</h-char><h-char class=hanzi cjk>調</h-char><h-hangable><h-char unicode=300d class=biaodian cjk bd-close bd-end><h-inner>」</h-inner><h-cs hidden=\"\"> </h-cs></h-char><h-cs><h-inner hidden=\"\"> </h-inner><h-char class=biaodian bd-close bd-end cjk>、</h-char></h-cs></h-hangable></em><h-char-group class=biaodian cjk portion><h-char unicode=300e class=biaodian cjk bd-open><h-cs hidden=\"\"> </h-cs><h-inner>『</h-inner></h-char></h-char-group><h-char-group class=biaodian cjk portion><h-char unicode=300e class=biaodian cjk bd-open><h-cs hidden=\"\"> </h-cs><h-inner>『</h-inner></h-char></h-char-group><strong><h-char-group class=biaodian cjk portion><h-char unicode=300e class=biaodian cjk bd-open><h-cs hidden=\"\"> </h-cs><h-inner>『</h-inner></h-char></h-char-group>重點<h-hangable><h-char unicode=300f class=biaodian cjk bd-close bd-end><h-inner>』</h-inner><h-cs hidden=\"\"> </h-cs></h-char><h-cs><h-inner hidden=\"\"> </h-inner><h-char class=biaodian bd-close bd-end cjk>。</h-char></h-cs></h-hangable></strong>'
