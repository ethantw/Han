(function(){
  ...
  test('Hanging Biaodian', function(){
    ...
    d.innerHTML = '標點……。';
    Han(d).renderHanging();
    htmlEqual(d.innerHTML, '標點<h-hangable>……<h-cs><h-inner hidden=""> </h-inner><h-char class=biaodian bd-close bd-end cjk>。</h-char></h-cs></h-hangable>');
    d.innerHTML = '「標點」。';
    Han(d).renderHanging();
    htmlEqual(d.innerHTML, '「標點<h-hangable>」<h-cs><h-inner hidden=""> </h-inner><h-char class=biaodian bd-close bd-end cjk>。</h-char></h-cs></h-hangable>');
  });
