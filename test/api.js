(function(){
  ...
  test('Hanging Biaodian', function(){
    ...
    d.innerHTML = '標點……。';
    Han(d).renderHanging();
    htmlEqual(d.innerHTML, '標點<h-hangable>……<h-cs><h-inner hidden=""> </h-inner><h-char class=biaodian close end cjk>。</h-char></h-cs></h-hangable>');
    d.innerHTML = '「標點」。';
    Han(d).renderHanging();
    htmlEqual(d.innerHTML, '「標點<h-hangable>」<h-cs><h-inner hidden=""> </h-inner><h-char class=biaodian close end cjk>。</h-char></h-cs></h-hangable>');
  });
  test('Jiya and Hanging', function(){
    ...
    if (support) {
      ...
      htmlEqual(d.innerHTML, '<a href=#><h-char unicode=300a class=biaodian cjk open><h-cs hidden=""> </h-cs><h-inner>《</h-inner></h-char>書名<h-hangable><h-char unicode=300b class=biaodian cjk close end><h-inner>》</h-inner><h-cs hidden=""> </h-cs></h-char><h-cs><h-inner hidden=""> </h-inner><h-char class=biaodian close end cjk>、</h-char></h-cs></h-hangable></a><h-char-group class=biaodian cjk portion><h-char unicode=300c class=biaodian cjk open><h-cs hidden=""> </h-cs><h-inner>「</h-inner></h-char></h-char-group><h-char-group class=biaodian cjk portion><h-char unicode=300c class=biaodian cjk open><h-cs hidden=""> </h-cs><h-inner>「</h-inner></h-char></h-char-group><em><h-char-group class=biaodian cjk portion><h-char unicode=300c class=biaodian cjk open><h-cs hidden=""> </h-cs><h-inner></h-inner></h-char></h-char-group><h-jinze class=tou><h-char unicode=300c class=biaodian cjk open>「</h-char><h-char class=hanzi cjk>強</h-char></h-jinze><h-jinze class=wei><h-char class=hanzi cjk>調</h-char><h-char unicode=300d class=biaodian cjk close end>」</h-char></h-jinze><h-hangable><h-char unicode=300d class=biaodian cjk close end><h-inner></h-inner><h-cs hidden=""> </h-cs></h-char><h-cs><h-inner hidden=""> </h-inner><h-char class=biaodian close end cjk>、</h-char></h-cs></h-hangable></em><h-char-group class=biaodian cjk portion><h-char unicode=300e class=biaodian cjk open><h-cs hidden=""> </h-cs><h-inner>『</h-inner></h-char></h-char-group><h-char-group class=biaodian cjk portion><h-char unicode=300e class=biaodian cjk open><h-cs hidden=""> </h-cs><h-inner>『</h-inner></h-char></h-char-group><strong><h-char-group class=biaodian cjk portion><h-char unicode=300e class=biaodian cjk open><h-cs hidden=""> </h-cs><h-inner>『</h-inner></h-char></h-char-group>重點<h-hangable><h-char unicode=300f class=biaodian cjk close end><h-inner>』</h-inner><h-cs hidden=""> </h-cs></h-char><h-cs><h-inner hidden=""> </h-inner><h-char class=biaodian close end cjk>。</h-char></h-cs></h-hangable></strong>');
    }
  });
}).call(this);
