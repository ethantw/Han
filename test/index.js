(function(){
  ...
  test('Emphasis marks', function(){
    ...
    Han(d).renderEm();
    if (support) {
      htmlEqual(d.innerHTML, '<em><h-char unicode=300c class=biaodian cjk bd-open>「</h-char>測<h-char unicode=300e class=biaodian cjk bd-open>『</h-char>試<h-char unicode=300f class=biaodian cjk bd-close bd-end>』</h-char><h-char unicode=300d class=biaodian cjk bd-close bd-end>」</h-char><h-char unicode=ff0c class=biaodian cjk bd-end>，</h-char>test <h-char class=punct>‘</h-char>this<h-char class=punct>!</h-char><h-char class=punct>’</h-char><h-char unicode=3002 class=biaodian cjk bd-end>。</h-char></em>');
    } else {
      htmlEqual(d.innerHTML, '<em><h-jinze class="tou"><h-char unicode="300c" class="biaodian cjk bd-open">「</h-char><h-char class="hanzi cjk">測</h-char></h-jinze><h-jinze class="touwei"><h-char unicode="300e" class="biaodian cjk bd-open">『</h-char><h-char class="hanzi cjk">試</h-char><h-char unicode="300f" class="biaodian cjk bd-close bd-end">』</h-char><h-char unicode="300d" class="biaodian cjk bd-close bd-end">」</h-char><h-char unicode="ff0c" class="biaodian cjk bd-end">，</h-char></h-jinze><h-word class="western"><h-char class="alphabet latin">t</h-char><h-char class="alphabet latin">e</h-char><h-char class="alphabet latin">s</h-char><h-char class="alphabet latin">t</h-char></h-word> <h-word class="western"><h-char class="punct">‘</h-char><h-char class="alphabet latin">t</h-char><h-char class="alphabet latin">h</h-char><h-char class="alphabet latin">i</h-char><h-char class="alphabet latin">s</h-char><h-char class="punct">!</h-char></h-word><h-jinze class="wei"><h-word class="western"><h-char class="punct">’</h-char></h-word><h-char unicode="3002" class="biaodian cjk bd-end">。</h-char></h-jinze></em>');
    }
  ...
  test('Interlinear annotations (Ruby)', function(){
    ...
    Han(d).renderRuby();
    qsa(d, 'h-ruby').forEach(function(it){
  ...
  test('Consecutive Biaodian (jiya)', function(a){
    var d;
    d = div();
    d.innerHTML = '<p>「字『字』？」字「字『字』」字？</p>';
    Han(d).renderJiya();
    a.domEqual(d.firstChild, $('<p><h-char unicode="300c" class="biaodian cjk bd-open bd-jiya"><h-inner>「</h-inner></h-char>字<h-char unicode="300e" class="biaodian cjk bd-open bd-jiya"><h-inner>『</h-inner></h-char>字<h-char unicode="300f" class="biaodian cjk bd-close bd-end bd-jiya bd-consecutive"><h-inner>』</h-inner></h-char><h-char unicode="ff1f" class="biaodian cjk bd-end bd-jiya bd-consecutive" prev="bd-close"><h-inner>？</h-inner></h-char><h-char unicode="300d" class="biaodian cjk bd-close bd-end bd-jiya bd-consecutive end-portion" prev="bd-end"><h-inner>」</h-inner></h-char>字<h-char unicode="300c" class="biaodian cjk bd-open bd-jiya"><h-inner>「</h-inner></h-char>字<h-char unicode="300e" class="biaodian cjk bd-open bd-jiya"><h-inner>『</h-inner></h-char>字<h-char unicode="300f" class="biaodian cjk bd-close bd-end bd-jiya bd-consecutive"><h-inner>』</h-inner></h-char><h-char unicode="300d" class="biaodian cjk bd-close bd-end bd-jiya bd-consecutive end-portion" prev="bd-close"><h-inner>」</h-inner></h-char>字<h-char unicode="ff1f" class="biaodian cjk bd-end bd-jiya"><h-inner>？</h-inner></h-char></p>'));
    d.innerHTML = '<p>字、「字」字，（字）字……「字」。';
    Han(d).renderJiya();
    a.domEqual(d.firstChild, $('<p>字<h-char unicode="3001" class="biaodian cjk bd-end bd-jiya bd-consecutive"><h-inner>、</h-inner></h-char><h-char unicode="300c" class="biaodian cjk bd-open bd-jiya bd-consecutive end-portion" prev="bd-end bd-cop"><h-inner>「</h-inner></h-char>字<h-char unicode="300d" class="biaodian cjk bd-close bd-end bd-jiya"><h-inner>」</h-inner></h-char>字<h-char unicode="ff0c" class="biaodian cjk bd-end bd-jiya bd-consecutive"><h-inner>，</h-inner></h-char><h-char unicode="ff08" class="biaodian cjk bd-open bd-jiya bd-consecutive end-portion" prev="bd-end bd-cop"><h-inner>（</h-inner></h-char>字<h-char unicode="ff09" class="biaodian cjk bd-close bd-end bd-jiya"><h-inner>）</h-inner></h-char>字<h-char unicode="2026" class="biaodian cjk bd-liga bd-jiya bd-consecutive"><h-inner>……</h-inner></h-char><h-char unicode="300c" class="biaodian cjk bd-open bd-jiya bd-consecutive end-portion" prev="bd-liga"><h-inner>「</h-inner></h-char>字<h-char unicode="300d" class="biaodian cjk bd-close bd-end bd-jiya bd-consecutive"><h-inner>」</h-inner></h-char><h-char unicode="3002" class="biaodian cjk bd-end bd-jiya bd-consecutive end-portion" prev="bd-close"><h-inner>。</h-inner></h-char></p>'));
    d.innerHTML = '<p>《書名》〈篇名〉（內容）';
    Han(d).renderJiya();
    a.domEqual(d.firstChild, $('<p><h-char unicode="300a" class="biaodian cjk bd-open bd-jiya"><h-inner>《</h-inner></h-char>書名<h-char unicode="300b" class="biaodian cjk bd-close bd-end bd-jiya bd-consecutive"><h-inner>》</h-inner></h-char><h-char unicode="3008" class="biaodian cjk bd-open bd-jiya bd-consecutive end-portion" prev="bd-close"><h-inner>〈</h-inner></h-char>篇名<h-char unicode="3009" class="biaodian cjk bd-close bd-end bd-jiya bd-consecutive"><h-inner>〉</h-inner></h-char><h-char unicode="ff08" class="biaodian cjk bd-open bd-jiya bd-consecutive end-portion" prev="bd-close"><h-inner>（</h-inner></h-char>內容<h-char unicode="ff09" class="biaodian cjk bd-close bd-end bd-jiya"><h-inner>）</h-inner></h-char>'));
    if (!Han.support.textemphasis) {
      d.innerHTML = '<p><em>《書名》〈篇名〉（內容）「『好』、不好」</em>';
      Han(d).renderElem().renderJiya();
      a.domEqual(d.firstChild, $('<p><em><h-cs class="jinze-outer jiya-outer" hidden=""> </h-cs><h-jinze class="tou"><h-char unicode="300a" class="biaodian cjk bd-open bd-jiya"><h-inner>《</h-inner></h-char><h-char class="hanzi cjk">書</h-char></h-jinze><h-jinze class="wei"><h-char class="hanzi cjk">名</h-char><h-char unicode="300b" class="biaodian cjk bd-close bd-end bd-jiya bd-consecutive"><h-inner>》</h-inner></h-char></h-jinze><h-cs prev="bd-close" class="jinze-outer jiya-outer" hidden=""> </h-cs><h-jinze class="tou"><h-char prev="bd-close" unicode="3008" class="biaodian cjk bd-open bd-jiya bd-consecutive end-portion"><h-inner>〈</h-inner></h-char><h-char class="hanzi cjk">篇</h-char></h-jinze><h-jinze class="wei"><h-char class="hanzi cjk">名</h-char><h-char unicode="3009" class="biaodian cjk bd-close bd-end bd-jiya bd-consecutive"><h-inner>〉</h-inner></h-char></h-jinze><h-cs prev="bd-close" class="jinze-outer jiya-outer" hidden=""> </h-cs><h-jinze class="tou"><h-char prev="bd-close" unicode="ff08" class="biaodian cjk bd-open bd-jiya bd-consecutive end-portion"><h-inner>（</h-inner></h-char><h-char class="hanzi cjk">內</h-char></h-jinze><h-jinze class="wei"><h-char class="hanzi cjk">容</h-char><h-char unicode="ff09" class="biaodian cjk bd-close bd-end bd-jiya bd-consecutive"><h-inner>）</h-inner></h-char></h-jinze><h-cs prev="bd-close" class="jinze-outer jiya-outer" hidden=""> </h-cs><h-jinze class="touwei"><h-char prev="bd-close" unicode="300c" class="biaodian cjk bd-open bd-jiya bd-consecutive"><h-inner>「</h-inner></h-char><h-char prev="bd-open" unicode="300e" class="biaodian cjk bd-open bd-jiya bd-consecutive end-portion"><h-inner>『</h-inner></h-char><h-char class="hanzi cjk">好</h-char><h-char unicode="300f" class="biaodian cjk bd-close bd-end bd-jiya bd-consecutive"><h-inner>』</h-inner></h-char><h-char prev="bd-close" unicode="3001" class="biaodian cjk bd-end bd-jiya bd-consecutive end-portion"><h-inner>、</h-inner></h-char></h-jinze><h-cs class="jinze-outer jiya-outer biaodian cjk bd-end bd-jiya bd-consecutive end-portion" hidden=""> </h-cs><h-char class="hanzi cjk">不</h-char><h-jinze class="wei"><h-char class="hanzi cjk">好</h-char><h-char unicode="300d" class="biaodian cjk bd-close bd-end bd-jiya"><h-inner>」</h-inner></h-char></h-jinze><h-cs class="jinze-outer jiya-outer" hidden=""> </h-cs></em></p>'));
      d.innerHTML = '<p><em>內容《書名》〈篇名〉（內容）「好、『不好』」</em>';
      Han(d).renderElem().renderJiya();
      a.domEqual(d.firstChild, $('<p><em><h-char class="hanzi cjk">內</h-char><h-char class="hanzi cjk">容</h-char><h-cs class="jinze-outer jiya-outer" hidden=""> </h-cs><h-jinze class="tou"><h-char unicode="300a" class="biaodian cjk bd-open bd-jiya"><h-inner>《</h-inner></h-char><h-char class="hanzi cjk">書</h-char></h-jinze><h-jinze class="wei"><h-char class="hanzi cjk">名</h-char><h-char unicode="300b" class="biaodian cjk bd-close bd-end bd-jiya bd-consecutive"><h-inner>》</h-inner></h-char></h-jinze><h-cs prev="bd-close" class="jinze-outer jiya-outer" hidden=""> </h-cs><h-jinze class="tou"><h-char prev="bd-close" unicode="3008" class="biaodian cjk bd-open bd-jiya bd-consecutive end-portion"><h-inner>〈</h-inner></h-char><h-char class="hanzi cjk">篇</h-char></h-jinze><h-jinze class="wei"><h-char class="hanzi cjk">名</h-char><h-char unicode="3009" class="biaodian cjk bd-close bd-end bd-jiya bd-consecutive"><h-inner>〉</h-inner></h-char></h-jinze><h-cs prev="bd-close" class="jinze-outer jiya-outer" hidden=""> </h-cs><h-jinze class="tou"><h-char prev="bd-close" unicode="ff08" class="biaodian cjk bd-open bd-jiya bd-consecutive end-portion"><h-inner>（</h-inner></h-char><h-char class="hanzi cjk">內</h-char></h-jinze><h-jinze class="wei"><h-char class="hanzi cjk">容</h-char><h-char unicode="ff09" class="biaodian cjk bd-close bd-end bd-jiya bd-consecutive"><h-inner>）</h-inner></h-char></h-jinze><h-cs prev="undefined" class="jinze-outer jiya-outer" hidden=""> </h-cs><h-jinze class="touwei"><h-char prev="bd-close" unicode="300c" class="biaodian cjk bd-open bd-jiya bd-consecutive end-portion"><h-inner>「</h-inner></h-char><h-char class="hanzi cjk">好</h-char><h-char unicode="3001" class="biaodian cjk bd-end bd-jiya bd-consecutive"><h-inner>、</h-inner></h-char></h-jinze><h-cs prev="bd-end bd-cop" class="jinze-outer jiya-outer" hidden=""> </h-cs><h-jinze class="tou"><h-char prev="bd-end bd-cop" unicode="300e" class="biaodian cjk bd-open bd-jiya bd-consecutive end-portion"><h-inner>『</h-inner></h-char><h-char class="hanzi cjk">不</h-char></h-jinze><h-jinze class="wei"><h-char class="hanzi cjk">好</h-char><h-char unicode="300f" class="biaodian cjk bd-close bd-end bd-jiya bd-consecutive"><h-inner>』</h-inner></h-char><h-char prev="bd-close" unicode="300d" class="biaodian cjk bd-close bd-end bd-jiya bd-consecutive end-portion"><h-inner>」</h-inner></h-char></h-jinze><h-cs class="jinze-outer jiya-outer biaodian cjk bd-close bd-end bd-jiya bd-consecutive end-portion" hidden=""> </h-cs></em></p>'));
      d.innerHTML = '<p>內容<em>《書名》〈篇名〉（內容）「好」、『不好』</em>';
      Han(d).renderElem().renderJiya();
      return a.domEqual(d.firstChild, $('<p>內容<em><h-cs class="jinze-outer jiya-outer" hidden=""> </h-cs><h-jinze class="tou"><h-char unicode="300a" class="biaodian cjk bd-open bd-jiya"><h-inner>《</h-inner></h-char><h-char class="hanzi cjk">書</h-char></h-jinze><h-jinze class="wei"><h-char class="hanzi cjk">名</h-char><h-char unicode="300b" class="biaodian cjk bd-close bd-end bd-jiya bd-consecutive"><h-inner>》</h-inner></h-char></h-jinze><h-cs prev="bd-close" class="jinze-outer jiya-outer" hidden=""> </h-cs><h-jinze class="tou"><h-char prev="bd-close" unicode="3008" class="biaodian cjk bd-open bd-jiya bd-consecutive end-portion"><h-inner>〈</h-inner></h-char><h-char class="hanzi cjk">篇</h-char></h-jinze><h-jinze class="wei"><h-char class="hanzi cjk">名</h-char><h-char unicode="3009" class="biaodian cjk bd-close bd-end bd-jiya bd-consecutive"><h-inner>〉</h-inner></h-char></h-jinze><h-cs prev="bd-close" class="jinze-outer jiya-outer" hidden=""> </h-cs><h-jinze class="tou"><h-char prev="bd-close" unicode="ff08" class="biaodian cjk bd-open bd-jiya bd-consecutive end-portion"><h-inner>（</h-inner></h-char><h-char class="hanzi cjk">內</h-char></h-jinze><h-jinze class="wei"><h-char class="hanzi cjk">容</h-char><h-char unicode="ff09" class="biaodian cjk bd-close bd-end bd-jiya bd-consecutive"><h-inner>）</h-inner></h-char></h-jinze><h-cs prev="bd-close" class="jinze-outer jiya-outer" hidden=""> </h-cs><h-jinze class="touwei"><h-char prev="bd-close" unicode="300c" class="biaodian cjk bd-open bd-jiya bd-consecutive end-portion"><h-inner>「</h-inner></h-char><h-char class="hanzi cjk">好</h-char><h-char unicode="300d" class="biaodian cjk bd-close bd-end bd-jiya bd-consecutive"><h-inner>」</h-inner></h-char><h-char prev="bd-close" unicode="3001" class="biaodian cjk bd-end bd-jiya bd-consecutive"><h-inner>、</h-inner></h-char></h-jinze><h-cs prev="bd-end bd-cop" class="jinze-outer jiya-outer" hidden=""> </h-cs><h-jinze class="tou"><h-char prev="bd-end bd-cop" unicode="300e" class="biaodian cjk bd-open bd-jiya bd-consecutive end-portion"><h-inner>『</h-inner></h-char><h-char class="hanzi cjk">不</h-char></h-jinze><h-jinze class="wei"><h-char class="hanzi cjk">好</h-char><h-char unicode="300f" class="biaodian cjk bd-close bd-end bd-jiya"><h-inner>』</h-inner></h-char></h-jinze><h-cs class="jinze-outer jiya-outer" hidden=""> </h-cs></em></p>'));
    }
  });
  test('Hanging Biaodian', function(a){
    ...
    Han(d).renderHanging();
    a.domEqual(d.firstChild, $('<p>點<h-char unicode="3001" class="biaodian cjk bd-end bd-hangable"><h-inner>、</h-inner></h-char>點<h-char unicode="ff0c" class="biaodian cjk bd-end bd-hangable"><h-inner>，</h-inner></h-char>點<h-char unicode="3002" class="biaodian cjk bd-end bd-hangable"><h-inner>。</h-inner></h-char>點<h-char unicode="ff0e" class="biaodian cjk bd-end bd-hangable"><h-inner>．</h-inner></h-char>'));
    d.innerHTML = '「標點。」';
    Han(d).renderHanging();
    htmlEqual(d.innerHTML, '「標點。」');
    d.innerHTML = '<p>標點……。';
    Han(d).renderHanging();
    a.domEqual(d.firstChild, $('<p>標點……<h-char unicode="3002" class="biaodian cjk bd-end bd-hangable"><h-inner>。</h-inner></h-char></p>'));
    d.innerHTML = '<p>「標點」。';
    Han(d).renderHanging();
    a.domEqual(d.firstChild, $('<p>「標點」<h-char unicode="3002" class="biaodian cjk bd-end bd-hangable"><h-inner>。</h-inner></h-char>'));
    if (!Han.support.textemphasis) {
      d.innerHTML = '<em>《書名》〈篇名〉（內容）「『好』、不好」</em>';
      Han(d).renderElem().renderHanging();
      return a.domEqual(d.firstChild, $('<em><h-jinze class="tou"><h-char unicode="300a" class="biaodian cjk bd-open">《</h-char><h-char class="hanzi cjk">書</h-char></h-jinze><h-jinze class="wei"><h-char class="hanzi cjk">名</h-char><h-char unicode="300b" class="biaodian cjk bd-close bd-end">》</h-char></h-jinze><h-jinze class="tou"><h-char unicode="3008" class="biaodian cjk bd-open">〈</h-char><h-char class="hanzi cjk">篇</h-char></h-jinze><h-jinze class="wei"><h-char class="hanzi cjk">名</h-char><h-char unicode="3009" class="biaodian cjk bd-close bd-end">〉</h-char></h-jinze><h-jinze class="tou"><h-char unicode="ff08" class="biaodian cjk bd-open">（</h-char><h-char class="hanzi cjk">內</h-char></h-jinze><h-jinze class="wei"><h-char class="hanzi cjk">容</h-char><h-char unicode="ff09" class="biaodian cjk bd-close bd-end">）</h-char></h-jinze><h-jinze class="touwei"><h-char unicode="300c" class="biaodian cjk bd-open">「</h-char><h-char unicode="300e" class="biaodian cjk bd-open">『</h-char><h-char class="hanzi cjk">好</h-char><h-char unicode="300f" class="biaodian cjk bd-close bd-end">』</h-char><h-char unicode="3001" class="biaodian cjk bd-end bd-hangable"><h-inner>、</h-inner></h-char></h-jinze><h-cs class="jinze-outer hangable-outer" hidden=""> </h-cs><h-char class="hanzi cjk">不</h-char><h-jinze class="wei"><h-char class="hanzi cjk">好</h-char><h-char unicode="300d" class="biaodian cjk bd-close bd-end">」</h-char></h-jinze></em>'));
    }
  });
  test('Jiya and Hanging', function(a){
    ...
    a.domEqual(d.firstChild, $('<p><h-char unicode="300c" class="biaodian cjk bd-open bd-jiya"><h-inner>「</h-inner></h-char>標<h-char unicode="300d" class="biaodian cjk bd-close bd-end bd-jiya bd-consecutive"><h-inner>」</h-inner></h-char><h-char unicode="3001" class="biaodian cjk bd-end bd-jiya bd-consecutive bd-hangable" prev="bd-close"><h-inner>、</h-inner></h-char><h-char unicode="300c" class="biaodian cjk bd-open bd-jiya bd-consecutive" prev="bd-end bd-cop"><h-inner>「</h-inner></h-char><h-char unicode="300e" class="biaodian cjk bd-open bd-jiya bd-consecutive end-portion" prev="bd-open"><h-inner>『</h-inner></h-char>標<h-char unicode="300f" class="biaodian cjk bd-close bd-end bd-jiya bd-consecutive"><h-inner>』</h-inner></h-char><h-char unicode="300d" class="biaodian cjk bd-close bd-end bd-jiya bd-consecutive" prev="bd-close"><h-inner>」</h-inner></h-char><h-char unicode="ff0c" class="biaodian cjk bd-end bd-jiya bd-consecutive bd-hangable" prev="bd-close"><h-inner>，</h-inner></h-char><h-char unicode="300a" class="biaodian cjk bd-open bd-jiya bd-consecutive end-portion" prev="bd-end bd-cop"><h-inner>《</h-inner></h-char>標<h-char unicode="300b" class="biaodian cjk bd-close bd-end bd-jiya bd-consecutive"><h-inner>》</h-inner></h-char><h-char unicode="3001" class="biaodian cjk bd-end bd-jiya bd-consecutive bd-hangable" prev="bd-close"><h-inner>、</h-inner></h-char><h-char unicode="3008" class="biaodian cjk bd-open bd-jiya bd-consecutive end-portion" prev="bd-end bd-cop"><h-inner>〈</h-inner></h-char>標<h-char unicode="3009" class="biaodian cjk bd-close bd-end bd-jiya bd-consecutive"><h-inner>〉</h-inner></h-char><h-char unicode="3002" class="biaodian cjk bd-end bd-jiya bd-consecutive end-portion bd-hangable" prev="bd-close"><h-inner>。</h-inner></h-char></p>'));
    d.innerHTML = '<p><a href="#">《書名》</a>、「文字」、<strong>『重點』</strong>。';
    Han(d).renderJiya().renderHanging();
    a.domEqual(d.firstChild, $('<p><a href="#"><h-char unicode="300a" class="biaodian cjk bd-open bd-jiya"><h-inner>《</h-inner></h-char>書名<h-char unicode="300b" class="biaodian cjk bd-close bd-end bd-jiya bd-consecutive"><h-inner>》</h-inner></h-char></a><h-char unicode="3001" class="biaodian cjk bd-end bd-jiya bd-consecutive bd-hangable" prev="bd-close"><h-inner>、</h-inner></h-char><h-char unicode="300c" class="biaodian cjk bd-open bd-jiya bd-consecutive end-portion" prev="bd-end bd-cop"><h-inner>「</h-inner></h-char>文字<h-char unicode="300d" class="biaodian cjk bd-close bd-end bd-jiya bd-consecutive"><h-inner>」</h-inner></h-char><h-char unicode="3001" class="biaodian cjk bd-end bd-jiya bd-consecutive bd-hangable" prev="bd-close"><h-inner>、</h-inner></h-char><strong><h-char unicode="300e" class="biaodian cjk bd-open bd-jiya bd-consecutive end-portion" prev="bd-end bd-cop"><h-inner>『</h-inner></h-char>重點<h-char unicode="300f" class="biaodian cjk bd-close bd-end bd-jiya bd-consecutive"><h-inner>』</h-inner></h-char></strong><h-char unicode="3002" class="biaodian cjk bd-end bd-jiya bd-consecutive end-portion bd-hangable" prev="bd-close"><h-inner>。</h-inner></h-char></p>'));
    d.innerHTML = '<p><a href="#">《書名》、</a><em>「強調」、</em><strong>『重點』</strong>。';
    Han(d).renderElem().renderJiya().renderHanging();
    support = Han.support.textemphasis;
    if (support) {
      a.domEqual(d.firstChild, $('<p><a href="#"><h-char unicode="300a" class="biaodian cjk bd-open bd-jiya"><h-inner>《</h-inner></h-char>書名<h-char unicode="300b" class="biaodian cjk bd-close bd-end bd-jiya bd-consecutive"><h-inner>》</h-inner></h-char><h-char unicode="3001" class="biaodian cjk bd-end bd-jiya bd-consecutive bd-hangable" prev="bd-close"><h-inner>、</h-inner></h-char></a><em><h-char unicode="300c" class="biaodian cjk bd-open bd-jiya bd-consecutive end-portion" prev="bd-end bd-cop"><h-inner>「</h-inner></h-char>強調<h-char unicode="300d" class="biaodian cjk bd-close bd-end bd-jiya bd-consecutive"><h-inner>」</h-inner></h-char><h-char unicode="3001" class="biaodian cjk bd-end bd-jiya bd-consecutive bd-hangable" prev="bd-close"><h-inner>、</h-inner></h-char></em><strong><h-char unicode="300e" class="biaodian cjk bd-open bd-jiya bd-consecutive end-portion" prev="bd-end bd-cop"><h-inner>『</h-inner></h-char>重點<h-char unicode="300f" class="biaodian cjk bd-close bd-end bd-jiya bd-consecutive"><h-inner>』</h-inner></h-char></strong><h-char unicode="3002" class="biaodian cjk bd-end bd-jiya bd-consecutive end-portion bd-hangable" prev="bd-close"><h-inner>。</h-inner></h-char></p>'));
    } else {
      a.domEqual(d.firstChild, $('<p><a href="#"><h-char unicode="300a" class="biaodian cjk bd-open bd-jiya"><h-inner>《</h-inner></h-char>書名<h-char unicode="300b" class="biaodian cjk bd-close bd-end bd-jiya bd-consecutive"><h-inner>》</h-inner></h-char><h-char prev="bd-close" unicode="3001" class="biaodian cjk bd-end bd-jiya bd-consecutive bd-hangable"><h-inner>、</h-inner></h-char></a><em><h-cs prev="bd-end bd-cop" class="jinze-outer jiya-outer" hidden=""> </h-cs><h-jinze class="tou"><h-char prev="bd-end bd-cop" unicode="300c" class="biaodian cjk bd-open bd-jiya bd-consecutive end-portion"><h-inner>「</h-inner></h-char><h-char class="hanzi cjk">強</h-char></h-jinze><h-jinze class="wei"><h-char class="hanzi cjk">調</h-char><h-char unicode="300d" class="biaodian cjk bd-close bd-end bd-jiya bd-consecutive"><h-inner>」</h-inner></h-char><h-char prev="bd-close" unicode="3001" class="biaodian cjk bd-end bd-jiya bd-consecutive bd-hangable"><h-inner>、</h-inner></h-char></h-jinze><h-cs class="jinze-outer jiya-outer biaodian cjk bd-end bd-jiya bd-consecutive hangable-outer" hidden=""> </h-cs></em><strong><h-char prev="bd-end bd-cop" unicode="300e" class="biaodian cjk bd-open bd-jiya bd-consecutive end-portion"><h-inner>『</h-inner></h-char>重點<h-char unicode="300f" class="biaodian cjk bd-close bd-end bd-jiya bd-consecutive"><h-inner>』</h-inner></h-char></strong><h-char prev="bd-close" unicode="3002" class="biaodian cjk bd-end bd-jiya bd-consecutive end-portion bd-hangable"><h-inner>。</h-inner></h-char></p>'));
    }
    d.innerHTML = '<p><a href="#">《書名》</a>、<em>「強調」</em>、<strong>『重點』</strong>。';
    Han(d).renderElem().renderJiya().renderHanging();
    support = Han.support.textemphasis;
    if (support) {
      return a.domEqual(d.firstChild, $('<p><a href="#"><h-char unicode="300a" class="biaodian cjk bd-open bd-jiya"><h-inner>《</h-inner></h-char>書名<h-char unicode="300b" class="biaodian cjk bd-close bd-end bd-jiya bd-consecutive"><h-inner>》</h-inner></h-char></a><h-char unicode="3001" class="biaodian cjk bd-end bd-jiya bd-consecutive bd-hangable" prev="bd-close"><h-inner>、</h-inner></h-char><em><h-char unicode="300c" class="biaodian cjk bd-open bd-jiya bd-consecutive end-portion" prev="bd-end bd-cop"><h-inner>「</h-inner></h-char>強調<h-char unicode="300d" class="biaodian cjk bd-close bd-end bd-jiya bd-consecutive"><h-inner>」</h-inner></h-char></em><h-char unicode="3001" class="biaodian cjk bd-end bd-jiya bd-consecutive bd-hangable" prev="bd-close"><h-inner>、</h-inner></h-char><strong><h-char unicode="300e" class="biaodian cjk bd-open bd-jiya bd-consecutive end-portion" prev="bd-end bd-cop"><h-inner>『</h-inner></h-char>重點<h-char unicode="300f" class="biaodian cjk bd-close bd-end bd-jiya bd-consecutive"><h-inner>』</h-inner></h-char></strong><h-char unicode="3002" class="biaodian cjk bd-end bd-jiya bd-consecutive end-portion bd-hangable" prev="bd-close"><h-inner>。</h-inner></h-char></p>'));
    } else {
      return a.domEqual(d.firstChild, $('<p><a href="#"><h-char unicode="300a" class="biaodian cjk bd-open bd-jiya"><h-inner>《</h-inner></h-char>書名<h-char unicode="300b" class="biaodian cjk bd-close bd-end bd-jiya bd-consecutive"><h-inner>》</h-inner></h-char></a><h-char prev="bd-close" unicode="3001" class="biaodian cjk bd-end bd-jiya bd-consecutive bd-hangable"><h-inner>、</h-inner></h-char><em><h-cs prev="bd-end bd-cop" class="jinze-outer jiya-outer" hidden=""> </h-cs><h-jinze class="tou"><h-char prev="bd-end bd-cop" unicode="300c" class="biaodian cjk bd-open bd-jiya bd-consecutive end-portion"><h-inner>「</h-inner></h-char><h-char class="hanzi cjk">強</h-char></h-jinze><h-jinze class="wei"><h-char class="hanzi cjk">調</h-char><h-char unicode="300d" class="biaodian cjk bd-close bd-end bd-jiya bd-consecutive"><h-inner>」</h-inner></h-char></h-jinze><h-cs class="jinze-outer jiya-outer biaodian cjk bd-close bd-end bd-jiya bd-consecutive" hidden=""></h-cs></em><h-char prev="bd-close" unicode="3001" class="biaodian cjk bd-end bd-jiya bd-consecutive bd-hangable"><h-inner>、</h-inner></h-char><strong><h-char prev="bd-end bd-cop" unicode="300e" class="biaodian cjk bd-open bd-jiya bd-consecutive end-portion"><h-inner>『</h-inner></h-char>重點<h-char unicode="300f" class="biaodian cjk bd-close bd-end bd-jiya bd-consecutive"><h-inner>』</h-inner></h-char></strong><h-char prev="bd-close" unicode="3002" class="biaodian cjk bd-end bd-jiya bd-consecutive end-portion bd-hangable"><h-inner>。</h-inner></h-char></p>'));
    }
  });
}).call(this);
