(function(){
  ...
  test('Consecutive Biaodian (jiya)', function(a){
    ...
    Han(d).renderJiya();
    return a.domEqual(d.firstChild, $('<h-char unicode="300a" class="biaodian cjk bd-open"><h-cs hidden=""> </h-cs><h-inner>《</h-inner></h-char>書名<h-char unicode="300b" class="biaodian cjk bd-close bd-end consecutive-bd"><h-inner>》</h-inner><h-cs hidden=""> </h-cs></h-char><h-char unicode="3008" class="biaodian cjk bd-open consecutive-bd end-portion" prev="bd-close"><h-cs hidden=""> </h-cs><h-inner>〈</h-inner></h-char>篇名<h-char unicode="3009" class="biaodian cjk bd-close bd-end consecutive-bd"><h-inner>〉</h-inner><h-cs hidden=""> </h-cs></h-char><h-char unicode="ff08" class="biaodian cjk bd-open consecutive-bd end-portion" prev="bd-close"><h-cs hidden=""> </h-cs><h-inner>（</h-inner></h-char>內容<h-char unicode="ff09" class="biaodian cjk bd-close bd-end"><h-inner>）</h-inner><h-cs hidden=""> </h-cs></h-char>'));
  });
  ...
  test('Jiya and Hanging', function(a){
    ...
    a.domEqual(d.firstChild, $('<p><h-char unicode="300c" class="biaodian cjk bd-open"><h-cs hidden=""> </h-cs><h-inner>「</h-inner></h-char>標<h-char unicode="300d" class="biaodian cjk bd-close bd-end consecutive-bd"><h-inner>」</h-inner><h-cs hidden=""> </h-cs></h-char><h-char unicode="3001" class="biaodian cjk bd-end consecutive-bd hangable" prev="bd-close"><h-cs hidden=""> </h-cs><h-inner>、</h-inner></h-char><h-char unicode="300c" class="biaodian cjk bd-open consecutive-bd" prev="bd-end bd-cop"><h-cs hidden=""> </h-cs><h-inner>「</h-inner></h-char><h-char unicode="300e" class="biaodian cjk bd-open consecutive-bd end-portion" prev="bd-open"><h-cs hidden=""> </h-cs><h-inner>『</h-inner></h-char>標<h-char unicode="300f" class="biaodian cjk bd-close bd-end consecutive-bd"><h-inner>』</h-inner><h-cs hidden=""> </h-cs></h-char><h-char unicode="300d" class="biaodian cjk bd-close bd-end consecutive-bd" prev="bd-close"><h-inner>」</h-inner><h-cs hidden=""> </h-cs></h-char><h-char unicode="ff0c" class="biaodian cjk bd-end consecutive-bd hangable" prev="bd-close"><h-cs hidden=""> </h-cs><h-inner>，</h-inner></h-char><h-char unicode="300a" class="biaodian cjk bd-open consecutive-bd end-portion" prev="bd-end bd-cop"><h-cs hidden=""> </h-cs><h-inner>《</h-inner></h-char>標<h-char unicode="300b" class="biaodian cjk bd-close bd-end consecutive-bd"><h-inner>》</h-inner><h-cs hidden=""> </h-cs></h-char><h-char unicode="3001" class="biaodian cjk bd-end consecutive-bd hangable" prev="bd-close"><h-cs hidden=""> </h-cs><h-inner>、</h-inner></h-char><h-char unicode="3008" class="biaodian cjk bd-open consecutive-bd end-portion" prev="bd-end bd-cop"><h-cs hidden=""> </h-cs><h-inner>〈</h-inner></h-char>標<h-char unicode="3009" class="biaodian cjk bd-close bd-end consecutive-bd"><h-inner>〉</h-inner><h-cs hidden=""> </h-cs></h-char><h-char unicode="3002" class="biaodian cjk bd-end consecutive-bd end-portion hangable" prev="bd-close"><h-cs hidden=""> </h-cs><h-inner>。</h-inner></h-char>'));
    d.innerHTML = '<p><a href="#">《書名》</a>、「文字」、<strong>『重點』</strong>。';
    Han(d).renderJiya().renderHanging();
    a.domEqual(d.firstChild, $('<p><a href="#"><h-char unicode="300a" class="biaodian cjk bd-open"><h-cs hidden=""> </h-cs><h-inner>《</h-inner></h-char>書名<h-char unicode="300b" class="biaodian cjk bd-close bd-end consecutive-bd"><h-inner>》</h-inner><h-cs hidden=""> </h-cs></h-char></a><h-char unicode="3001" class="biaodian cjk bd-end consecutive-bd hangable" prev="bd-close"><h-cs hidden=""> </h-cs><h-inner>、</h-inner></h-char><h-char unicode="300c" class="biaodian cjk bd-open consecutive-bd end-portion" prev="bd-end bd-cop"><h-cs hidden=""> </h-cs><h-inner>「</h-inner></h-char>文字<h-char unicode="300d" class="biaodian cjk bd-close bd-end consecutive-bd"><h-inner>」</h-inner><h-cs hidden=""> </h-cs></h-char><h-char unicode="3001" class="biaodian cjk bd-end consecutive-bd hangable" prev="bd-close"><h-cs hidden=""> </h-cs><h-inner>、</h-inner></h-char><strong><h-char unicode="300e" class="biaodian cjk bd-open consecutive-bd end-portion" prev="bd-end bd-cop"><h-cs hidden=""> </h-cs><h-inner>『</h-inner></h-char>重點<h-char unicode="300f" class="biaodian cjk bd-close bd-end consecutive-bd"><h-inner>』</h-inner><h-cs hidden=""> </h-cs></h-char></strong><h-char unicode="3002" class="biaodian cjk bd-end consecutive-bd end-portion hangable" prev="bd-close"><h-cs hidden=""> </h-cs><h-inner>。</h-inner></h-char>'));
    d.innerHTML = '<p><a href="#">《書名》、</a><em>「強調」、</em><strong>『重點』</strong>。';
    Han(d).renderElem().renderJiya().renderHanging();
    support = Han.support.textemphasis;
    if (support) {
      a.domEqual(d.firstChild, $('<p><a href="#"><h-char unicode="300a" class="biaodian cjk bd-open"><h-cs hidden=""> </h-cs><h-inner>《</h-inner></h-char>書名<h-char unicode="300b" class="biaodian cjk bd-close bd-end consecutive-bd"><h-inner>》</h-inner><h-cs hidden=""> </h-cs></h-char><h-char unicode="3001" class="biaodian cjk bd-end consecutive-bd hangable" prev="bd-close"><h-cs hidden=""> </h-cs><h-inner>、</h-inner></h-char></a><em><h-char unicode="300c" class="biaodian cjk bd-open consecutive-bd end-portion" prev="bd-end bd-cop"><h-cs hidden=""> </h-cs><h-inner>「</h-inner></h-char>強調<h-char unicode="300d" class="biaodian cjk bd-close bd-end consecutive-bd"><h-inner>」</h-inner><h-cs hidden=""> </h-cs></h-char><h-char unicode="3001" class="biaodian cjk bd-end consecutive-bd hangable" prev="bd-close"><h-cs hidden=""> </h-cs><h-inner>、</h-inner></h-char></em><strong><h-char unicode="300e" class="biaodian cjk bd-open consecutive-bd end-portion" prev="bd-end bd-cop"><h-cs hidden=""> </h-cs><h-inner>『</h-inner></h-char>重點<h-char unicode="300f" class="biaodian cjk bd-close bd-end consecutive-bd"><h-inner>』</h-inner><h-cs hidden=""> </h-cs></h-char></strong><h-char unicode="3002" class="biaodian cjk bd-end consecutive-bd end-portion hangable" prev="bd-close"><h-cs hidden=""> </h-cs><h-inner>。</h-inner></h-char>'));
    } else {
      a.domEqual(d.firstChild, $('<p><a href="#"><h-char unicode="300a" class="biaodian cjk bd-open"><h-cs hidden=""> </h-cs><h-inner>《</h-inner></h-char>書名<h-char unicode="300b" class="biaodian cjk bd-close bd-end consecutive-bd"><h-inner>》</h-inner><h-cs hidden=""> </h-cs></h-char><h-char prev="bd-close" unicode="3001" class="biaodian cjk bd-end consecutive-bd hangable"><h-cs hidden=""> </h-cs><h-inner>、</h-inner></h-char></a><em><h-cs prev="bd-end bd-cop" class="jinze-outer jiya-outer " hidden=""> </h-cs><h-jinze class="tou"><h-char prev="bd-end bd-cop" unicode="300c" class="biaodian cjk bd-open consecutive-bd end-portion"><h-cs hidden=""> </h-cs><h-inner>「</h-inner></h-char><h-char class="hanzi cjk">強</h-char></h-jinze><h-jinze class="wei"><h-char class="hanzi cjk">調</h-char><h-char unicode="300d" class="biaodian cjk bd-close bd-end consecutive-bd"><h-inner>」</h-inner><h-cs hidden=""> </h-cs></h-char><h-char prev="bd-close" unicode="3001" class="biaodian cjk bd-end consecutive-bd hangable"><h-cs hidden=""> </h-cs><h-inner>、</h-inner></h-char></h-jinze><h-cs prev="" class="jinze-outer jiya-outer biaodian cjk bd-end consecutive-bd hangable-outer" hidden=""> </h-cs></em><strong><h-char prev="bd-end bd-cop" unicode="300e" class="biaodian cjk bd-open consecutive-bd end-portion"><h-cs hidden=""> </h-cs><h-inner>『</h-inner></h-char>重點<h-char unicode="300f" class="biaodian cjk bd-close bd-end consecutive-bd"><h-inner>』</h-inner><h-cs hidden=""> </h-cs></h-char></strong><h-char prev="bd-close" unicode="3002" class="biaodian cjk bd-end consecutive-bd end-portion hangable"><h-cs hidden=""> </h-cs><h-inner>。</h-inner></h-char></p>'));
    }
    d.innerHTML = '<p><a href="#">《書名》</a>、<em>「強調」</em>、<strong>『重點』</strong>。';
    Han(d).renderElem().renderJiya().renderHanging();
    support = Han.support.textemphasis;
    if (support) {
      return a.domEqual(d.firstChild, $('<p><a href="#"><h-char unicode="300a" class="biaodian cjk bd-open"><h-cs hidden=""> </h-cs><h-inner>《</h-inner></h-char>書名<h-char unicode="300b" class="biaodian cjk bd-close bd-end consecutive-bd"><h-inner>》</h-inner><h-cs hidden=""> </h-cs></h-char></a><h-char unicode="3001" class="biaodian cjk bd-end consecutive-bd hangable" prev="bd-close"><h-cs hidden=""> </h-cs><h-inner>、</h-inner></h-char><em><h-char unicode="300c" class="biaodian cjk bd-open consecutive-bd end-portion" prev="bd-end bd-cop"><h-cs hidden=""> </h-cs><h-inner>「</h-inner></h-char>強調<h-char unicode="300d" class="biaodian cjk bd-close bd-end consecutive-bd"><h-inner>」</h-inner><h-cs hidden=""> </h-cs></h-char></em><h-char unicode="3001" class="biaodian cjk bd-end consecutive-bd hangable" prev="bd-close"><h-cs hidden=""> </h-cs><h-inner>、</h-inner></h-char><strong><h-char unicode="300e" class="biaodian cjk bd-open consecutive-bd end-portion" prev="bd-end bd-cop"><h-cs hidden=""> </h-cs><h-inner>『</h-inner></h-char>重點<h-char unicode="300f" class="biaodian cjk bd-close bd-end consecutive-bd"><h-inner>』</h-inner><h-cs hidden=""> </h-cs></h-char></strong><h-char unicode="3002" class="biaodian cjk bd-end consecutive-bd end-portion hangable" prev="bd-close"><h-cs hidden=""> </h-cs><h-inner>。</h-inner></h-char></p>'));
    } else {
      return a.domEqual(d.firstChild, $('<p><a href="#"><h-char unicode="300a" class="biaodian cjk bd-open"><h-cs hidden=""> </h-cs><h-inner>《</h-inner></h-char>書名<h-char unicode="300b" class="biaodian cjk bd-close bd-end consecutive-bd"><h-inner>》</h-inner><h-cs hidden=""> </h-cs></h-char></a><h-char prev="bd-close" unicode="3001" class="biaodian cjk bd-end consecutive-bd hangable"><h-cs hidden=""> </h-cs><h-inner>、</h-inner></h-char><em><h-cs prev="bd-end bd-cop" class="jinze-outer jiya-outer " hidden=""> </h-cs><h-jinze class="tou"><h-char prev="bd-end bd-cop" unicode="300c" class="biaodian cjk bd-open consecutive-bd end-portion"><h-cs hidden=""> </h-cs><h-inner>「</h-inner></h-char><h-char class="hanzi cjk">強</h-char></h-jinze><h-jinze class="wei"><h-char class="hanzi cjk">調</h-char><h-char unicode="300d" class="biaodian cjk bd-close bd-end consecutive-bd"><h-inner>」</h-inner><h-cs hidden=""> </h-cs></h-char></h-jinze><h-cs prev="" class="jinze-outer jiya-outer biaodian cjk bd-close bd-end consecutive-bd" hidden=""> </h-cs></em><h-char prev="bd-close" unicode="3001" class="biaodian cjk bd-end consecutive-bd hangable"><h-cs hidden=""> </h-cs><h-inner>、</h-inner></h-char><strong><h-char prev="bd-end bd-cop" unicode="300e" class="biaodian cjk bd-open consecutive-bd end-portion"><h-cs hidden=""> </h-cs><h-inner>『</h-inner></h-char>重點<h-char unicode="300f" class="biaodian cjk bd-close bd-end consecutive-bd"><h-inner>』</h-inner><h-cs hidden=""> </h-cs></h-char></strong><h-char prev="bd-close" unicode="3002" class="biaodian cjk bd-end consecutive-bd end-portion hangable"><h-cs hidden=""> </h-cs><h-inner>。</h-inner></h-char></p>'));
    }
  });
}).call(this);
