(function(){
  ...
  test('Consecutive Biaodian (jiya)', function(a){
    ...
    if (!Han.support.textemphasis) {
      ...
      return a.domEqual(d.firstChild, $('<p><em><h-cs class="jinze-outer jiya-outer" hidden=""> </h-cs><h-jinze class="tou"><h-char unicode="300a" class="biaodian cjk bd-open bd-jiya"><h-inner>《</h-inner></h-char><h-char class="hanzi cjk">書</h-char></h-jinze><h-jinze class="wei"><h-char class="hanzi cjk">名</h-char><h-char unicode="300b" class="biaodian cjk bd-close bd-end bd-jiya bd-consecutive"><h-inner>》</h-inner></h-char></h-jinze><h-cs class="jinze-outer jiya-outerbiaodian cjk bd-close bd-end bd-jiya bd-consecutive" hidden=""> </h-cs><h-cs prev="bd-close" class="jinze-outer jiya-outer" hidden=""> </h-cs><h-jinze class="tou"><h-char prev="bd-close" unicode="3008" class="biaodian cjk bd-open bd-jiya bd-consecutive end-portion"><h-inner>〈</h-inner></h-char><h-char class="hanzi cjk">篇</h-char></h-jinze><h-jinze class="wei"><h-char class="hanzi cjk">名</h-char><h-char unicode="3009" class="biaodian cjk bd-close bd-end bd-jiya bd-consecutive"><h-inner>〉</h-inner></h-char></h-jinze><h-cs class="jinze-outer jiya-outerbiaodian cjk bd-close bd-end bd-jiya bd-consecutive" hidden=""> </h-cs><h-cs prev="bd-close" class="jinze-outer jiya-outer" hidden=""> </h-cs><h-jinze class="tou"><h-char prev="bd-close" unicode="ff08" class="biaodian cjk bd-open bd-jiya bd-consecutive end-portion"><h-inner>（</h-inner></h-char><h-char class="hanzi cjk">內</h-char></h-jinze><h-jinze class="wei"><h-char class="hanzi cjk">容</h-char><h-char unicode="ff09" class="biaodian cjk bd-close bd-end bd-jiya bd-consecutive"><h-inner>）</h-inner></h-char></h-jinze><h-cs class="jinze-outer jiya-outerbiaodian cjk bd-close bd-end bd-jiya bd-consecutive" hidden=""> </h-cs><h-cs prev="bd-close" class="jinze-outer jiya-outer" hidden=""> </h-cs><h-jinze class="touwei"><h-char prev="bd-close" unicode="300c" class="biaodian cjk bd-open bd-jiya bd-consecutive"><h-inner>「</h-inner></h-char><h-char prev="bd-open" unicode="300e" class="biaodian cjk bd-open bd-jiya bd-consecutive end-portion"><h-inner>『</h-inner></h-char><h-char class="hanzi cjk">好</h-char><h-char unicode="300f" class="biaodian cjk bd-close bd-end bd-jiya bd-consecutive"><h-inner>』</h-inner></h-char><h-char prev="bd-close" unicode="3001" class="biaodian cjk bd-end bd-jiya bd-consecutive end-portion"><h-inner>、</h-inner></h-char></h-jinze><h-cs class="jinze-outer jiya-outerbiaodian cjk bd-open bd-jiya bd-consecutivebiaodian cjk bd-open bd-jiya bd-consecutive end-portionbiaodian cjk bd-close bd-end bd-jiya bd-consecutivebiaodian cjk bd-end bd-jiya bd-consecutive end-portion" hidden=""> </h-cs><h-char class="hanzi cjk">不</h-char><h-jinze class="wei"><h-char class="hanzi cjk">好</h-char><h-char unicode="300d" class="biaodian cjk bd-close bd-end bd-jiya"><h-inner>」</h-inner></h-char></h-jinze><h-cs class="jinze-outer jiya-outer" hidden=""> </h-cs></em></p>'));
    }
  });
  ...
  test('Jiya and Hanging', function(a){
    ...
    if (support) {
      ...
      a.domEqual(d.firstChild, $('<p><a href="#"><h-char unicode="300a" class="biaodian cjk bd-open bd-jiya"><h-inner>《</h-inner></h-char>書名<h-char unicode="300b" class="biaodian cjk bd-close bd-end bd-jiya bd-consecutive"><h-inner>》</h-inner></h-char><h-char prev="bd-close" unicode="3001" class="biaodian cjk bd-end bd-jiya bd-consecutive bd-hangable"><h-inner>、</h-inner></h-char></a><em><h-cs prev="bd-end bd-cop" class="jinze-outer jiya-outer" hidden=""> </h-cs><h-jinze class="tou"><h-char prev="bd-end bd-cop" unicode="300c" class="biaodian cjk bd-open bd-jiya bd-consecutive end-portion"><h-inner>「</h-inner></h-char><h-char class="hanzi cjk">強</h-char></h-jinze><h-jinze class="wei"><h-char class="hanzi cjk">調</h-char><h-char unicode="300d" class="biaodian cjk bd-close bd-end bd-jiya bd-consecutive"><h-inner>」</h-inner></h-char><h-char prev="bd-close" unicode="3001" class="biaodian cjk bd-end bd-jiya bd-consecutive bd-hangable"><h-inner>、</h-inner></h-char></h-jinze><h-cs class="jinze-outer jiya-outerbiaodian cjk bd-close bd-end bd-jiya bd-consecutivebiaodian cjk bd-end bd-jiya bd-consecutive hangable-outer" hidden=""> </h-cs></em><strong><h-char prev="bd-end bd-cop" unicode="300e" class="biaodian cjk bd-open bd-jiya bd-consecutive end-portion"><h-inner>『</h-inner></h-char>重點<h-char unicode="300f" class="biaodian cjk bd-close bd-end bd-jiya bd-consecutive"><h-inner>』</h-inner></h-char></strong><h-char prev="bd-close" unicode="3002" class="biaodian cjk bd-end bd-jiya bd-consecutive end-portion bd-hangable"><h-inner>。</h-inner></h-char></p>'));
    }
    d.innerHTML = '<p><a href="#">《書名》</a>、<em>「強調」</em>、<strong>『重點』</strong>。';
    Han(d).renderElem().renderJiya().renderHanging();
    support = Han.support.textemphasis;
    if (support) {
      ...
      return a.domEqual(d.firstChild, $('<p><a href="#"><h-char unicode="300a" class="biaodian cjk bd-open bd-jiya"><h-inner>《</h-inner></h-char>書名<h-char unicode="300b" class="biaodian cjk bd-close bd-end bd-jiya bd-consecutive"><h-inner>》</h-inner></h-char></a><h-char prev="bd-close" unicode="3001" class="biaodian cjk bd-end bd-jiya bd-consecutive bd-hangable"><h-inner>、</h-inner></h-char><em><h-cs prev="bd-end bd-cop" class="jinze-outer jiya-outer" hidden=""> </h-cs><h-jinze class="tou"><h-char prev="bd-end bd-cop" unicode="300c" class="biaodian cjk bd-open bd-jiya bd-consecutive end-portion"><h-inner>「</h-inner></h-char><h-char class="hanzi cjk">強</h-char></h-jinze><h-jinze class="wei"><h-char class="hanzi cjk">調</h-char><h-char unicode="300d" class="biaodian cjk bd-close bd-end bd-jiya bd-consecutive"><h-inner>」</h-inner></h-char></h-jinze><h-cs class="jinze-outer jiya-outerbiaodian cjk bd-close bd-end bd-jiya bd-consecutive" hidden=""> </h-cs></em><h-char prev="bd-close" unicode="3001" class="biaodian cjk bd-end bd-jiya bd-consecutive bd-hangable"><h-inner>、</h-inner></h-char><strong><h-char prev="bd-end bd-cop" unicode="300e" class="biaodian cjk bd-open bd-jiya bd-consecutive end-portion"><h-inner>『</h-inner></h-char>重點<h-char unicode="300f" class="biaodian cjk bd-close bd-end bd-jiya bd-consecutive"><h-inner>』</h-inner></h-char></strong><h-char prev="bd-close" unicode="3002" class="biaodian cjk bd-end bd-jiya bd-consecutive end-portion bd-hangable"><h-inner>。</h-inner></h-char></p>'));
    }
  });
}).call(this);
