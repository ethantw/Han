(function(){
  ...
  test('Biaodian jiya', function(){
    ...
    Han(d).renderJiya();
    htmlEqual(d.innerHTML, '<h-char unicode="300c" class="biaodian cjk bd-open"><h-cs hidden=""> </h-cs><h-inner>「</h-inner></h-char>字<h-char unicode="300e" class="biaodian cjk bd-open"><h-cs hidden=""> </h-cs><h-inner>『</h-inner></h-char>字<h-char unicode="300f" class="biaodian cjk bd-close bd-end consecutive-bd is-first"><h-inner>』</h-inner><h-cs hidden=""> </h-cs></h-char><h-char unicode="ff1f" class="biaodian cjk bd-end consecutive-bd is-inner"><h-inner>？</h-inner><h-cs hidden=""> </h-cs></h-char><h-char unicode="300d" class="biaodian cjk bd-close bd-end consecutive-bd is-end"><h-inner>」</h-inner><h-cs hidden=""> </h-cs></h-char>字<h-char unicode="300c" class="biaodian cjk bd-open"><h-cs hidden=""> </h-cs><h-inner>「</h-inner></h-char>字<h-char unicode="300e" class="biaodian cjk bd-open"><h-cs hidden=""> </h-cs><h-inner>『</h-inner></h-char>字<h-char unicode="300f" class="biaodian cjk bd-close bd-end consecutive-bd is-first"><h-inner>』</h-inner><h-cs hidden=""> </h-cs></h-char><h-char unicode="300d" class="biaodian cjk bd-close bd-end consecutive-bd is-end"><h-inner>」</h-inner><h-cs hidden=""> </h-cs></h-char>字<h-char unicode="ff1f" class="biaodian cjk bd-end"><h-inner>？</h-inner><h-cs hidden=""> </h-cs></h-char>');
    d.innerHTML = '字、「字」字，（字）字……「字」。';
    Han(d).renderJiya();
    htmlEqual(d.innerHTML, '字<h-char unicode="3001" class="biaodian cjk bd-end consecutive-bd is-first"><h-inner>、</h-inner><h-cs hidden=""> </h-cs></h-char><h-char unicode="300c" class="biaodian cjk bd-open consecutive-bd is-end"><h-cs hidden=""> </h-cs><h-inner>「</h-inner></h-char>字<h-char unicode="300d" class="biaodian cjk bd-close bd-end"><h-inner>」</h-inner><h-cs hidden=""> </h-cs></h-char>字<h-char unicode="ff0c" class="biaodian cjk bd-end consecutive-bd is-first"><h-inner>，</h-inner><h-cs hidden=""> </h-cs></h-char><h-char unicode="ff08" class="biaodian cjk bd-open consecutive-bd is-end"><h-cs hidden=""> </h-cs><h-inner>（</h-inner></h-char>字<h-char unicode="ff09" class="biaodian cjk bd-close bd-end"><h-inner>）</h-inner><h-cs hidden=""> </h-cs></h-char>字<h-char unicode="2026" class="biaodian cjk bd-liga consecutive-bd is-first">……</h-char><h-char unicode="300c" class="biaodian cjk bd-open consecutive-bd is-end"><h-cs hidden=""> </h-cs><h-inner>「</h-inner></h-char>字<h-char unicode="300d" class="biaodian cjk bd-close bd-end consecutive-bd is-first"><h-inner>」</h-inner><h-cs hidden=""> </h-cs></h-char><h-char unicode="3002" class="biaodian cjk bd-end consecutive-bd is-end"><h-inner>。</h-inner><h-cs hidden=""> </h-cs></h-char>');
    d.innerHTML = '《書名》〈篇名〉（內容）';
    Han(d).renderJiya();
    return htmlEqual(d.innerHTML, '<h-char unicode="300a" class="biaodian cjk bd-open"><h-cs hidden=""> </h-cs><h-inner>《</h-inner></h-char>書名<h-char unicode="300b" class="biaodian cjk bd-close bd-end consecutive-bd is-first"><h-inner>》</h-inner><h-cs hidden=""> </h-cs></h-char><h-char unicode="3008" class="biaodian cjk bd-open consecutive-bd is-end"><h-cs hidden=""> </h-cs><h-inner>〈</h-inner></h-char>篇名<h-char unicode="3009" class="biaodian cjk bd-close bd-end consecutive-bd is-first"><h-inner>〉</h-inner><h-cs hidden=""> </h-cs></h-char><h-char unicode="ff08" class="biaodian cjk bd-open consecutive-bd is-end"><h-cs hidden=""> </h-cs><h-inner>（</h-inner></h-char>內容<h-char unicode="ff09" class="biaodian cjk bd-close bd-end"><h-inner>）</h-inner><h-cs hidden=""> </h-cs></h-char>');
  });
  ...
  test('Jiya and Hanging', function(){
    ...
    htmlEqual(d.innerHTML, '<h-char unicode="300c" class="biaodian cjk bd-open"><h-cs hidden=""> </h-cs><h-inner>「</h-inner></h-char>標<h-char unicode="300d" class="biaodian cjk bd-close bd-end consecutive-bd is-first"><h-inner>」</h-inner><h-cs hidden=""> </h-cs></h-char><h-char unicode="3001" class="biaodian cjk bd-end consecutive-bd is-inner hangable"><h-cs hidden=""> </h-cs><h-inner>、</h-inner></h-char><h-char unicode="300c" class="biaodian cjk bd-open consecutive-bd is-inner"><h-cs hidden=""> </h-cs><h-inner>「</h-inner></h-char><h-char unicode="300e" class="biaodian cjk bd-open consecutive-bd is-end"><h-cs hidden=""> </h-cs><h-inner>『</h-inner></h-char>標<h-char unicode="300f" class="biaodian cjk bd-close bd-end consecutive-bd is-first"><h-inner>』</h-inner><h-cs hidden=""> </h-cs></h-char><h-char unicode="300d" class="biaodian cjk bd-close bd-end consecutive-bd is-inner"><h-inner>」</h-inner><h-cs hidden=""> </h-cs></h-char><h-char unicode="ff0c" class="biaodian cjk bd-end consecutive-bd is-inner hangable"><h-cs hidden=""> </h-cs><h-inner>，</h-inner></h-char><h-char unicode="300a" class="biaodian cjk bd-open consecutive-bd is-end"><h-cs hidden=""> </h-cs><h-inner>《</h-inner></h-char>標<h-char unicode="300b" class="biaodian cjk bd-close bd-end consecutive-bd is-first"><h-inner>》</h-inner><h-cs hidden=""> </h-cs></h-char><h-char unicode="3001" class="biaodian cjk bd-end consecutive-bd is-inner hangable"><h-cs hidden=""> </h-cs><h-inner>、</h-inner></h-char><h-char unicode="3008" class="biaodian cjk bd-open consecutive-bd is-end"><h-cs hidden=""> </h-cs><h-inner>〈</h-inner></h-char>標<h-char unicode="3009" class="biaodian cjk bd-close bd-end consecutive-bd is-first"><h-inner>〉</h-inner><h-cs hidden=""> </h-cs></h-char><h-char unicode="3002" class="biaodian cjk bd-end consecutive-bd is-end hangable"><h-cs hidden=""> </h-cs><h-inner>。</h-inner></h-char>');
    d.innerHTML = '<a href="#">《書名》</a>、「文字」、<strong>『重點』</strong>。';
    Han(d).renderJiya().renderHanging();
    htmlEqual(d.innerHTML, '<a href="#"><h-char unicode="300a" class="biaodian cjk bd-open"><h-cs hidden=""> </h-cs><h-inner>《</h-inner></h-char>書名<h-char unicode="300b" class="biaodian cjk bd-close bd-end consecutive-bd is-first"><h-inner>》</h-inner><h-cs hidden=""> </h-cs></h-char></a><h-char unicode="3001" class="biaodian cjk bd-end consecutive-bd is-inner hangable"><h-cs hidden=""> </h-cs><h-inner>、</h-inner></h-char><h-char unicode="300c" class="biaodian cjk bd-open consecutive-bd is-end"><h-cs hidden=""> </h-cs><h-inner>「</h-inner></h-char>文字<h-char unicode="300d" class="biaodian cjk bd-close bd-end consecutive-bd is-first"><h-inner>」</h-inner><h-cs hidden=""> </h-cs></h-char><h-char unicode="3001" class="biaodian cjk bd-end consecutive-bd is-inner hangable"><h-cs hidden=""> </h-cs><h-inner>、</h-inner></h-char><strong><h-char unicode="300e" class="biaodian cjk bd-open consecutive-bd is-end"><h-cs hidden=""> </h-cs><h-inner>『</h-inner></h-char>重點<h-char unicode="300f" class="biaodian cjk bd-close bd-end consecutive-bd is-first"><h-inner>』</h-inner><h-cs hidden=""> </h-cs></h-char></strong><h-char unicode="3002" class="biaodian cjk bd-end consecutive-bd is-end hangable"><h-cs hidden=""> </h-cs><h-inner>。</h-inner></h-char>');
    d.innerHTML = '<a href="#">《書名》、</a><em>「強調」、</em><strong>『重點』</strong>。';
    Han(d).renderElem().renderJiya().renderHanging();
    support = Han.support.textemphasis;
    if (support) {
      htmlEqual(d.innerHTML, '<a href="#"><h-char unicode="300a" class="biaodian cjk bd-open"><h-cs hidden=""> </h-cs><h-inner>《</h-inner></h-char>書名<h-char unicode="300b" class="biaodian cjk bd-close bd-end consecutive-bd is-first"><h-inner>》</h-inner><h-cs hidden=""> </h-cs></h-char><h-char unicode="3001" class="biaodian cjk bd-end consecutive-bd is-inner hangable"><h-cs hidden=""> </h-cs><h-inner>、</h-inner></h-char></a><em><h-char unicode="300c" class="biaodian cjk bd-open consecutive-bd is-end"><h-cs hidden=""> </h-cs><h-inner>「</h-inner></h-char>強調<h-char unicode="300d" class="biaodian cjk bd-close bd-end consecutive-bd is-first"><h-inner>」</h-inner><h-cs hidden=""> </h-cs></h-char><h-char unicode="3001" class="biaodian cjk bd-end consecutive-bd is-inner hangable"><h-cs hidden=""> </h-cs><h-inner>、</h-inner></h-char></em><strong><h-char unicode="300e" class="biaodian cjk bd-open consecutive-bd is-end"><h-cs hidden=""> </h-cs><h-inner>『</h-inner></h-char>重點<h-char unicode="300f" class="biaodian cjk bd-close bd-end consecutive-bd is-first"><h-inner>』</h-inner><h-cs hidden=""> </h-cs></h-char></strong><h-char unicode="3002" class="biaodian cjk bd-end consecutive-bd is-end hangable"><h-cs hidden=""> </h-cs><h-inner>。</h-inner></h-char>');
    } else {
      htmlEqual(d.innerHTML, '<a href="#"><h-char unicode="300a" class="biaodian cjk bd-open"><h-cs hidden=""> </h-cs><h-inner>《</h-inner></h-char>書名<h-char unicode="300b" class="biaodian cjk bd-close bd-end consecutive-bd is-first"><h-inner>》</h-inner><h-cs hidden=""> </h-cs></h-char><h-char unicode="3001" class="biaodian cjk bd-end consecutive-bd is-inner hangable"><h-cs hidden=""> </h-cs><h-inner>、</h-inner></h-char></a><em><h-jinze class="tou"><h-char unicode="300c" class="biaodian cjk bd-open consecutive-bd is-end"><h-cs hidden=""> </h-cs><h-inner>「</h-inner></h-char><h-char class="hanzi cjk">強</h-char></h-jinze><h-jinze class="wei"><h-char class="hanzi cjk">調</h-char><h-char unicode="300d" class="biaodian cjk bd-close bd-end consecutive-bd is-first"><h-inner>」</h-inner><h-cs hidden=""> </h-cs></h-char><h-char unicode="3001" class="biaodian cjk bd-end consecutive-bd is-inner hangable"><h-cs hidden=""> </h-cs><h-inner>、</h-inner></h-char></h-jinze></em><strong><h-char unicode="300e" class="biaodian cjk bd-open consecutive-bd is-end"><h-cs hidden=""> </h-cs><h-inner>『</h-inner></h-char>重點<h-char unicode="300f" class="biaodian cjk bd-close bd-end consecutive-bd is-first"><h-inner>』</h-inner><h-cs hidden=""> </h-cs></h-char></strong><h-char unicode="3002" class="biaodian cjk bd-end consecutive-bd is-end hangable"><h-cs hidden=""> </h-cs><h-inner>。</h-inner></h-char>');
    }
    d.innerHTML = '<a href="#">《書名》</a>、<em>「強調」</em>、<strong>『重點』</strong>。';
    Han(d).renderElem().renderJiya().renderHanging();
    support = Han.support.textemphasis;
    if (support) {
      htmlEqual(d.innerHTML, '<a href="#"><h-char unicode="300a" class="biaodian cjk bd-open"><h-cs hidden=""> </h-cs><h-inner>《</h-inner></h-char>書名<h-char unicode="300b" class="biaodian cjk bd-close bd-end consecutive-bd is-first"><h-inner>》</h-inner><h-cs hidden=""> </h-cs></h-char></a><h-char unicode="3001" class="biaodian cjk bd-end consecutive-bd is-inner hangable"><h-cs hidden=""> </h-cs><h-inner>、</h-inner></h-char><em><h-char unicode="300c" class="biaodian cjk bd-open consecutive-bd is-end"><h-cs hidden=""> </h-cs><h-inner>「</h-inner></h-char>強調<h-char unicode="300d" class="biaodian cjk bd-close bd-end consecutive-bd is-first"><h-inner>」</h-inner><h-cs hidden=""> </h-cs></h-char></em><h-char unicode="3001" class="biaodian cjk bd-end consecutive-bd is-inner hangable"><h-cs hidden=""> </h-cs><h-inner>、</h-inner></h-char><strong><h-char unicode="300e" class="biaodian cjk bd-open consecutive-bd is-end"><h-cs hidden=""> </h-cs><h-inner>『</h-inner></h-char>重點<h-char unicode="300f" class="biaodian cjk bd-close bd-end consecutive-bd is-first"><h-inner>』</h-inner><h-cs hidden=""> </h-cs></h-char></strong><h-char unicode="3002" class="biaodian cjk bd-end consecutive-bd is-end hangable"><h-cs hidden=""> </h-cs><h-inner>。</h-inner></h-char>');
    } else {
      htmlEqual(d.innerHTML, '<a href="#"><h-char unicode="300a" class="biaodian cjk bd-open"><h-cs hidden=""> </h-cs><h-inner>《</h-inner></h-char>書名<h-char unicode="300b" class="biaodian cjk bd-close bd-end consecutive-bd is-first"><h-inner>》</h-inner><h-cs hidden=""> </h-cs></h-char></a><h-char unicode="3001" class="biaodian cjk bd-end consecutive-bd is-inner hangable"><h-cs hidden=""> </h-cs><h-inner>、</h-inner></h-char><em><h-jinze class="tou"><h-char unicode="300c" class="biaodian cjk bd-open consecutive-bd is-end"><h-cs hidden=""> </h-cs><h-inner>「</h-inner></h-char><h-char class="hanzi cjk">強</h-char></h-jinze><h-jinze class="wei"><h-char class="hanzi cjk">調</h-char><h-char unicode="300d" class="biaodian cjk bd-close bd-end consecutive-bd is-first"><h-inner>」</h-inner><h-cs hidden=""> </h-cs></h-char></h-jinze></em><h-char unicode="3001" class="biaodian cjk bd-end consecutive-bd is-inner hangable"><h-cs hidden=""> </h-cs><h-inner>、</h-inner></h-char><strong><h-char unicode="300e" class="biaodian cjk bd-open consecutive-bd is-end"><h-cs hidden=""> </h-cs><h-inner>『</h-inner></h-char>重點<h-char unicode="300f" class="biaodian cjk bd-close bd-end consecutive-bd is-first"><h-inner>』</h-inner><h-cs hidden=""> </h-cs></h-char></strong><h-char unicode="3002" class="biaodian cjk bd-end consecutive-bd is-end hangable"><h-cs hidden=""> </h-cs><h-inner>。</h-inner></h-char>');
    }
  });
}).call(this);
