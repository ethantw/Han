...
test 'Hanging Biaodian', ( a ) ->
  ...
  Han d .renderHanging!
  a.dom-equal d.firstChild, $( '<p>點<h-char unicode="3001" class="biaodian cjk bd-end bd-hangable"><h-inner>、</h-inner></h-char>點<h-char unicode="ff0c" class="biaodian cjk bd-end bd-hangable"><h-inner>，</h-inner></h-char>點<h-char unicode="3002" class="biaodian cjk bd-end bd-hangable"><h-inner>。</h-inner></h-char>點<h-char unicode="ff0e" class="biaodian cjk bd-end bd-hangable"><h-inner>．</h-inner></h-char>' )
  ...
  d.innerHTML = '<p>標點……。'
  Han d .renderHanging!
  a.dom-equal d.firstChild, $( '<p>標點……<h-char unicode="3002" class="biaodian cjk bd-end bd-hangable"><h-inner>。</h-inner></h-char></p>' )

  d.innerHTML = '<p>「標點」。'
  Han d .renderHanging!
  a.dom-equal d.firstChild, $( '<p>「標點」<h-char unicode="3002" class="biaodian cjk bd-end bd-hangable"><h-inner>。</h-inner></h-char>' )
