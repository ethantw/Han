...
test 'Hanging Biaodian', ( a ) ->
  ...
  d.innerHTML = '點、點，點。點．'
  Han d .renderHanging!
  html-equal d.innerHTML, '點<h-char unicode=3001 class=biaodian cjk bd-end hangable><h-cs hidden=\"\"> </h-cs><h-inner>、</h-inner></h-char>點<h-char unicode=ff0c class=biaodian cjk bd-end hangable><h-cs hidden=\"\"> </h-cs><h-inner>，</h-inner></h-char>點<h-char unicode=3002 class=biaodian cjk bd-end hangable><h-cs hidden=\"\"> </h-cs><h-inner>。</h-inner></h-char>點<h-char unicode=ff0e class=biaodian cjk bd-end hangable><h-cs hidden=\"\"> </h-cs><h-inner>．</h-inner></h-char>'
  ...
  d.innerHTML = '標點……。'
  Han d .renderHanging!
  html-equal d.innerHTML, '標點……<h-char unicode=3002 class=biaodian cjk bd-end hangable><h-cs hidden=\"\"> </h-cs><h-inner>。</h-inner></h-char>'
